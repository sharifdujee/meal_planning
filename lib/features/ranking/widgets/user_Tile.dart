...
import '../model/ranking_page State.dart'; // Using your custom text widget
            ...
            children: [
              Row(
                children: [
                  ...
                  SizedBox(width: 4.w,),
                  GestureDetector(
                      child: Image.asset(IconPath.arrowDown,height: 12.h,width: 12.w,color: const Color(0xFF469271),)
                  )
                ],
              ),
              CustomText(
