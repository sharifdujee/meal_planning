...
class BreakTimeScreen extends ConsumerWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: CustomButton(text: "Guardar", onPressed: () {
                showCustomDialog(context, imagePath: IconPath.success, title: "Confirmación", buttonText: "Hecho", message: "Tu tiempo de descanso se ha añadido correctamente a la lista.", onPressed: (){
                  context.pop();
                });
              }),
            )
