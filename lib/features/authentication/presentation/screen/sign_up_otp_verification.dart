...
class SignupOtpVerificationCodeScreen extends ConsumerStatefulWidget {
  const SignupOtpVerificationCodeScreen({super.key});

  @override
  ConsumerState<SignupOtpVerificationCodeScreen> createState() =>
      _VerificationCodeScreenState();
}

class _VerificationCodeScreenState
    extends ConsumerState<SignupOtpVerificationCodeScreen> {
  String? email;
