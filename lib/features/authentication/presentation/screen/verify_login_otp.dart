...
class LoginVerificationCodeScreen extends ConsumerStatefulWidget {
  const LoginVerificationCodeScreen({super.key});

  @override
  ConsumerState<LoginVerificationCodeScreen> createState() =>
      _VerificationCodeScreenState();
}

class _VerificationCodeScreenState
    extends ConsumerState<LoginVerificationCodeScreen> {
  String? email;
